...
public class getSearchCitiesWeatherInCircle extends APIInit {
    ...
    @When("User call search cities weather in circle with lat {string} and lon {string} without number of city")
    ...
    @When("User call search cities weather in circle with lat {string} and lon {string} with number of city {string}")
